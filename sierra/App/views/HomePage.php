...
<?php $this->view("layout/header",$data);?>
    ...
    <section>
        <div class="relative content-center h-max md:h-auto pt-[60px] md:pt-[80px]">
            <div class="relative flex items-center justify-center bg-cover bg-center bg-no-repeat w-full h-screen md:h-[500px] pt-10" style="background-image: url('assets/image/banner.webp');">
            
                <div class="absolute transform -translate-x-1/2 top-8 left-1/2">
                    <img src="assets/image/logo_2.png" class="w-[120px] h-auto md:w-[168px] opacity-25">
                </div>
        
                <div class="flex flex-col items-start justify-center pl-4 md:pl-16 text-left w-full max-w-[400px] md:max-w-none banner">
                    <p class="text-sm font-medium leading-tight text-black md:text-2xl ">
                        NEW TREND<br>
                    </p>
                    <p class="flex items-center text-2xl font-extrabold text-black md:text-7xl">
                        COLLUSION
                    </p>    
                    <div class="mt-4 md:mt-8">
                        <button class="inline-block px-4 py-2 text-sm font-semibold text-white transition transform bg-gray-500 rounded-md shadow-lg hover:bg-gray-700 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 md:px-6 md:py-3 md:text-lg">
                            SHOP NEW
                        </button>
                    </div>
                </div>  
    ...
    <section class="pt-12 bg-white category">
        
        <div class="pb-8 text-center">
            <span class="text-sm font-semibold text-red-500">LATEST NEWS</span>
            <h2 class="text-2xl font-semibold text-gray-800 md:text-2xl">Fashion New Trends</h2>
        </div>

        <div class="container grid grid-cols-2 gap-2 px-4 mx-auto md:grid-cols-4 lg:grid-cols-4">
            <div class="relative overflow-hidden group md:col-span-2 md:row-span-2">
                <img src="assets/image/category1.jpg" alt="Women's Collection" class="object-cover w-full h-[250px] md:h-[350px]">
            ...
            <div class="relative overflow-hidden group md:col-span-1 md:row-span-1">
                <img src="assets/image/category4.jpg" alt="Accessories Collection" class="object-cover w-full h-[175px] md:h-[175px]">
                <div class="absolute inset-0 flex flex-col justify-end p-4 transition-opacity duration-300 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100">
            ...
            <div class="relative overflow-hidden group md:col-span-1 md:row-span-1">
                <img src="assets/image/category2.png" alt="Kids Collection" class="object-cover w-full h-[175px] md:h-[175px]">
                <div class="absolute inset-0 flex flex-col justify-end p-4 transition-opacity duration-300 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100">
            ...
            <div class="relative overflow-hidden group md:col-span-2 md:row-span-2">
                <img src="assets/image/category3.jpg" alt="Men's Collection" class="object-cover w-full h-[250px] md:h-[350px]">
                <div class="absolute inset-0 flex flex-col justify-end p-4 transition-opacity duration-300 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100">
            ...
            <div id="menSlider" class="grid grid-cols-2 px-4 overflow-hidden gap-x-4 gap-y-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 lg:px-8">
                ...
                <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1 lg:aspect-none lg:h-80">
                        <img src="assets/image/product/men/product1.png" alt="ADIDAS BASKETBALL LONG SLEEVE TEE" class="object-cover object-center w-full h-full lg:h-full lg:w-full">
                    </div>
                ...
                <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1 lg:aspect-none lg:h-80">
                        <img src="assets/image/product/men/product2.png" alt="ADIDAS BASKETBALL LONG SLEEVE TEE" class="object-cover object-center w-full h-full lg:h-full lg:w-full">
                    </div>
                    <div class="flex justify-between mt-4">
                        <div>
                            <h3 class="text-sm text-gray-700">
                ...
                <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1 lg:aspect-none lg:h-80">
                        <img src="assets/image/product/men/product3.png" alt="ADIDAS BASKETBALL LONG SLEEVE TEE" class="object-cover object-center w-full h-full lg:h-full lg:w-full">
                    </div>
                    <div class="flex justify-between mt-4">
                        <div>
                            <h3 class="text-sm text-gray-700">
                ...
                <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1 lg:aspect-none lg:h-80">
                        <img src="assets/image/product/men/product4.png" alt="ADIDAS BASKETBALL LONG SLEEVE TEE" class="object-cover object-center w-full h-full lg:h-full lg:w-full">
                    </div>
                    <div class="flex justify-between mt-4">
                        <div>
                            <h3 class="text-sm text-gray-700">
                ...
                <div class="relative group">
                    <div class="w-full overflow-hidden bg-gray-200 rounded-md aspect-w-1 aspect-h-1 lg:aspect-none lg:h-80">
                        <img src="assets/image/product/men/product5.png" alt="ADIDAS BASKETBALL LONG SLEEVE TEE" class="object-cover object-center w-full h-full lg:h-full lg:w-full">
                    </div>
                    <div class="flex justify-between mt-4">
                        <div>
                            <h3 class="text-sm text-gray-700">
    ...
    <section class="category">
        <div class="mb-12 text-center md:px-8 lg:px-16">
            <span class="text-sm font-semibold text-red-500">What Shop</span>
            <h2 class="text-2xl font-semibold text-gray-800 md:text-2xl">About Us</h2>
        </div>
        ...
        <div class="flex flex-col justify-between md:flex-row ">
            <div class="italic leading-relaxed text-gray-700 md:w-1/2 md:pl-8 lg:pl-16">
                ...
                <p class="pt-24 mt-6 text-4xl italic font-semibold text-red-500">#Sierra_Fashion</p>
            </div>
            <div class="flex justify-end mt-8 md:w-1/2 md:mt-0">
                <img src="assets/image/about3.png" alt="Fashion Image" class="h-[430px]" >
            </div>
        </div>
    </section>
    ...
    <section class="pt-12 pb-6 category">
        ...
        <div class="flex flex-wrap items-center space-x-6 space-y-4 justify-evenly md:space-y-0 gap-7">
            <img src="assets/image/brand1.png" alt="Adidas" class="h-12 md:h-28">
            <img src="assets/image/brand2.png" alt="Puma" class="h-12 md:h-28">
            <img src="assets/image/brand4.png" alt="Lacoste" class="h-12 md:h-28">
            <img src="assets/image/brand5.png" alt="Levi's" class="h-12 md:h-28">
            <img src="assets/image/brand3.png" alt="Nike" class="h-12 md:h-28">
            <img src="assets/image/brand6.png" alt="Hugo Boss" class="h-12 md:h-28">
        </div>
    </section>
